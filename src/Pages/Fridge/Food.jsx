...
const Food = ({ food }) => {
    ...
    return (
        <div className={`${expiration ? 'border-4 border-red-700 bg-gradient-to-b from-white to-red-100':"border-3 border-amber-500 bg-gradient-to-b from-white to-yellow-100"} rounded-xl  shadow-2xl mx-12 md:mx-8 lg:mx-0 px-4 lg:px-2`}>
            <div>
