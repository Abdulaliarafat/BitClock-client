    ...
    return (
        <div>
            <div className='max-w-5xl mx-auto px-10 md:px-24 py-5  bg-gradient-to-b from-yellow-500 to-yellow-100 rounded-2xl shadow-2xl my-5'>
                <div className='flex justify-center items-center px-10  mx-auto space-y-4'>
                    <Lottie animationData={LottieAnimation} className='h-20 w-33'></Lottie>
                    <h1 className='font-bold text-white text-3xl text-balance mb-3'>Add food</h1>
                </div>
                <form onSubmit={handleAddFood} className='md:px-4 py-2' >
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-5'>
                        ...
                        <fieldset className="fieldset bg-gradient-to-l from-green-50 to-green-100 border-base-300 rounded-box  border p-4">
                            ...
                            <input type="date" name='addeddate' className="input w-full " placeholder="Enter Added Date" required />
                        </fieldset>
                        <fieldset className="fieldset bg-gradient-to-l from-green-50 to-green-100 border-base-300 rounded-box  border p-4">
