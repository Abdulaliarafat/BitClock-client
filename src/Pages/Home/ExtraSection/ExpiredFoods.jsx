...
const ExpiredFoods = ({food}) => {
    console.log(food)
    return (
        <div className='flex flex-col border-2 border-green-700 rounded-xl bg-gradient-to-b from-white to-green-200 shadow-2xl mx-12 md:mx-8 lg:mx-0 px-2 lg:px-2'>
            <div>
