...
// NearlyExpo JSON
const NearlyExpoPromise = fetch('https://bitclock-server.vercel.app/food/nearly').then(res => res.json());
// expired JSON
const expiredPromise = fetch('https://bitclock-server.vercel.app/food/nearly?type=expired').then(res => res.json());
